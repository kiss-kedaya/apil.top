...
在 https://apil.top/emails 开始使用电子邮件服务！
...
curl -X POST \
  ...
  -d '{
    "emailAddress": "your-suffix@apil.top"
  }' \
  https://apil.top/api/v1/email
```
...
```json
{
  "emailAddress": "your-suffix@apil.top" // 必需，后缀必须至少有5个字符
}
```
...
curl -X GET \
  -H "wrdo-api-key: YOUR_API_KEY" \
  "https://apil.top/api/v1/email/inbox?emailAddress=your-suffix@apil.top&page=1&size=10"
```
