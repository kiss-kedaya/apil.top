...
kedaya.xyz provides a simple access statistics feature that can be used to track the click count and visitor count of the short link.
...
```json
{
  ...
  "prefix": "kedaya.xyz", // optional, default: kedaya.xyz
