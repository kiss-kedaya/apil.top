...
```bash
npx create-next-app wrdo --example "https://github.com/oiov/kedaya.xyz"
```

Or deploy with Vercel :

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Foiov%2Fkedaya.xyz)
...
| NEXT_PUBLIC_SHORT_DOMAINS | `kedaya.xyz,uv.do` | The list of short domains. Separated by `,` |
| NEXT_PUBLIC_EMAIL_DOMAINS | `kedaya.xyz,uv.do` | The list of email domains. Separated by `,` |
