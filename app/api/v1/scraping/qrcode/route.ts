...
export async function POST(req: Request) {
  try {
    ...
    const link = body.url;
    const width = parseInt(body.width || "200");
    const margin = parseInt(body.margin || "4");
    const dark = body.dark || "#000000";
    const light = body.light || "#ffffff";
    const type = body.type || "png"; // png  | jpeg | webp | string
